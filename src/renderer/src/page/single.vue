<template>
  <a-textarea v-model:value="link" placeholder="单个链接" :rows="2" autoSize allowClear />
  <a-button type="primary" @click="getList" :loading="loading" :disabled="!link.length" style="marginTop:10px;">
    <template #icon><SearchOutlined /></template>
    一键提取
  </a-button>
  <List ref="listRef" :list="list" @clearList="clearList"/>
</template>
...
const link = ref(true ? 'https://v.kuaishou.com/HHB8ye' : ' https://v.douyin.com/S4G1P1x/')
